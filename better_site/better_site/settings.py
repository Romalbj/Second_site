"""
Django settings for better_site project.
...
SECRET_KEY = 'django-insecure-&sa6i^0d2b)8w@=gs^m)d-6_2!374u1vsi3nmea+6lx%^v20u5'
...
WSGI_APPLICATION = 'better_site.wsgi.application'
